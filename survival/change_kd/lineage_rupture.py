...
kb = 0.02   # breaking rate

# [4, 16, 64]  run them one by one
cell_cycle = 64  # unit: h
# cell_cycle = 16
# cell_cycle = 4

kd = np.log(2)/cell_cycle  # division rate
...
np.save(f"data_kd{cell_cycle}.npy", rupture_times)
